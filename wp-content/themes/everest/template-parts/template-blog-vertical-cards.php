...
/**
 * Template Name: Ever Template Blog Vertical
 * The template for the Blog Vertical
 *
...
<div class="uk-section uk-section-large uk-padding-remove-top">
    ...
    <div class="uk-container uk-container-large">
        <h2 class="uk-margin-large"><?php the_field('titulo_todos_posts_blog') ?></h2>
        ...
        <!-- <a href="<?php echo get_post_type_archive_link('services') ?>"> Todos Serviços </a> -->
    </div>
</div>
<!-- end blog card -->
